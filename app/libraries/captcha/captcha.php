...
//        $_SESSION[$this->session_var] = $text;
        ...
        $CI->session->set_userdata($this->session_var, $text);
    ...
    //verify result
    public function verify_result($code)
    {
        $CI =& get_instance();
        $CI->load->library('session');
        if ($CI->session->userdata($this->session_var) == $code)
        {
            $CI->session->unset_userdata($this->session_var);
            return true;
        }
        else
        {
