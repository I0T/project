		...
		return this.each(function(){
			...
			if(slideboxSlide.length>1){ //if more than 1 slides
				...
				if(options.controlsPosition.buttonsPosition=="outside"){
					//slidebox.after("<a href='#' class='slideboxPrevious'></a><a href='#' class='slideboxNext'></a>"); //rhf 2014/2/20
				}else{
					//slidebox.append("<a href='#' class='slideboxPrevious'></a><a href='#' class='slideboxNext'></a>"); //rhf
				}
